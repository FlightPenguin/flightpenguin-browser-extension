...
/* harmony import */ var _getLayovers__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./getLayovers */ "./src/skyscanner/parser/getLayovers.ts");
...
/* harmony import */ var _ui_manageLayoversIframe__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../ui/manageLayoversIframe */ "./src/skyscanner/ui/manageLayoversIframe.ts");
/* harmony import */ var _getFlightLayovers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./getFlightLayovers */ "./src/skyscanner/parser/getFlightLayovers.ts");
function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest(); }
...
var getLayovers = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(function* (flightCard) {
    ...
    yield (0,_shared_utilities_waitFor__WEBPACK_IMPORTED_MODULE_0__.waitForAppearance)(30000, LEG_CONTAINER_SELECTOR, iframeDoc);
    ...
    var departureLayovers = (0,_getFlightLayovers__WEBPACK_IMPORTED_MODULE_2__.getFlightLayovers)(departureLegContainer);
    var returnLayovers = returnLegContainer ? (0,_getFlightLayovers__WEBPACK_IMPORTED_MODULE_2__.getFlightLayovers)(returnLegContainer) : [];
...
var openFlightDetails = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator(function* (flightCard) {
    return yield (0,_ui_manageLayoversIframe__WEBPACK_IMPORTED_MODULE_1__.createLayoversIframe)(flightCard);
  });
...
var closeFlightDetails = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator(function* (flightCard) {
    yield (0,_ui_manageLayoversIframe__WEBPACK_IMPORTED_MODULE_1__.deleteLayoversIframe)(flightCard);
  });
...
var getUnsentFlights = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(function* (formData) {
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        var flight = yield (0,_getFlight__WEBPACK_IMPORTED_MODULE_2__.getFlight)(flightCard, formData);
  ...
  return function getUnsentFlights(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
var handleCaptcha = /*#__PURE__*/function () {
  ...
  return function handleCaptcha(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
var createLayoversIframe = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(function* (flightCard) {
    ...
    var iframeDocument = yield (0,_shared_utilities_createInvisibleIframe__WEBPACK_IMPORTED_MODULE_1__.createInvisibleIframe)(flightCard, link, 120000, "", [IFRAME_CLASSNAME]);
    yield (0,_shared_utilities_waitFor__WEBPACK_IMPORTED_MODULE_2__.waitForDisappearance)(120000, IFRAME_LOADING_SELECTOR, iframeDocument);
...
chrome.runtime.onMessage.addListener( /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(function* (message) {
    switch (message.event) {
      case "BEGIN_PARSING":
        yield scrapeFlights(message.formData);
        break;
...
var scrapeFlights = /*#__PURE__*/function () {
  ...
  return function scrapeFlights(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
})();
