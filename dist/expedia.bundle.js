...
var getFlight = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(function* (element, formData, isReturn) {
  ...
  return function getFlight(_x, _x2, _x3) {
...
var getFlights = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(function* () {
    ...
    var loadingTimeout = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 120000;
    ...
    yield (0,_shared_utilities_waitFor__WEBPACK_IMPORTED_MODULE_2__.waitForAppearance)(loadingTimeout, CONTAINER_SHELL_SELECTOR);

    if (selectedFlight) {
      yield (0,_shared_utilities_waitFor__WEBPACK_IMPORTED_MODULE_2__.waitForAppearance)(loadingTimeout, RETURN_FLIGHT_LINK_SELECTOR);
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        var flight = yield (0,_getFlight__WEBPACK_IMPORTED_MODULE_4__.getFlight)(flightCard, formData, !!selectedFlight);
...
var getLayovers = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(function* (modal) {
    ...
    var formData = arguments.length > 2 ? arguments[2] : undefined;
    var isReturn = arguments.length > 3 ? arguments[3] : undefined;
...
var getLegDetails = function getLegDetails(leg, legIndex, formData, isReturn, elapsedTimezoneOffset, previousLegDetails) {
  ...
  var arrivalTime = getArrivalTime(arrival, legDepartureDate);

  if (!!previousLegDetails && isLayoverOvernight(previousLegDetails, departureTime)) {
    departureTime += "+1";

    if (arrivalTime.includes("+")) {
      var tokens = arrivalTime.split("+");
      var excessDays = Number(tokens[1]) - 1;
      arrivalTime = "".concat(tokens[0], "+").concat(excessDays);
    }
  }
...
var getArrivalTime = function getArrivalTime(arrival, legDepartureDate) {
  var _arrival$textContent, _arrival$textContent2;
  ...
  if ((_arrival$textContent2 = arrival.textContent) !== null && _arrival$textContent2 !== void 0 && _arrival$textContent2.toLowerCase().includes("arrives")) {
    var rawArrivalDate = arrival.textContent.split(/Arrives/i).slice(-1)[0].trim();
    var arrivalDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.default)(rawArrivalDate, "EEE, MMM d", new Date());

    if (arrivalDate < legDepartureDate) {
      arrivalDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.default)(arrivalDate, 1);
    }

    var dateDiff = Math.floor((arrivalDate.valueOf() - legDepartureDate.valueOf()) / 86400000);

    if (dateDiff) {
      time += "+".concat(dateDiff);
    }
  }
...
var getArrivalAirport = function getArrivalAirport(arrival) {
  var _arrival$textContent3, _arrival$textContent4, _arrival$textContent5, _airportCode;

  var airportCode = (_arrival$textContent3 = arrival.textContent) === null || _arrival$textContent3 === void 0 ? void 0 : _arrival$textContent3.slice(((_arrival$textContent4 = arrival.textContent) === null || _arrival$textContent4 === void 0 ? void 0 : _arrival$textContent4.indexOf("(")) + 1, (_arrival$textContent5 = arrival.textContent) === null || _arrival$textContent5 === void 0 ? void 0 : _arrival$textContent5.indexOf(")"));

  if (((_airportCode = airportCode) === null || _airportCode === void 0 ? void 0 : _airportCode.length) !== 3) {
    var _arrival$textContent6;

    airportCode = (_arrival$textContent6 = arrival.textContent) === null || _arrival$textContent6 === void 0 ? void 0 : _arrival$textContent6.split("-")[1].split("Arrives")[0].trim(); // no airport, just listing the city
  }
...
var getLegDepartureDate = function getLegDepartureDate(previousLegDetails, departureDate) {
  var tripDepartureDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.default)(departureDate, "yyyy-MM-dd", new Date());

  if (!previousLegDetails) {
    return tripDepartureDate;
  }

  var excessDays = Number(previousLegDetails.toTimeDetails.excessDays || "0");
  return (0,date_fns__WEBPACK_IMPORTED_MODULE_6__.default)(tripDepartureDate, excessDays);
};
  ...
  var _ref = _asyncToGenerator(function* (message) {
    switch (message.event) {
      case "BEGIN_PARSING":
        ...
        yield scrapeDepartureFlights(formData);
        break;
...
var scrapeDepartureFlights = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(function* (formData) {
    try {
      var flights = yield (0,_parser_getFlights__WEBPACK_IMPORTED_MODULE_2__.getFlights)(null, 30000, formData);
  ...
  return function scrapeDepartureFlights(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
