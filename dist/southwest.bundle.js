...
;// CONCATENATED MODULE: ./src/southwest/contentScript.js
...
function querySouthwestDOM(htmlCollection) {
  return _toConsumableArray(htmlCollection).map(function (containerNode) {
    ...
    var fromTime = standardizeTimeString(fromTimeRaw).replace("departs", "");
    var toTime = standardizeTimeString(toTimeRaw).replace("arrives", "");
