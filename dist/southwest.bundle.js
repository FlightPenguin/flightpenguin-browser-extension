...
/***/ "./src/shared/utilities/isScraperFlag.ts":
/*!***********************************************!*\
  !*** ./src/shared/utilities/isScraperFlag.ts ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "isScraperFlag": () => (/* binding */ isScraperFlag),
/* harmony export */   "setScraperFlag": () => (/* binding */ setScraperFlag)
/* harmony export */ });
var KEY_NAME = "fp-scraper-flag";
var isScraperFlag = function isScraperFlag() {
  return JSON.parse(sessionStorage.getItem(KEY_NAME) || "false");
};
var setScraperFlag = function setScraperFlag() {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getDurationValue": () => (/* binding */ getDurationValue)
/* harmony export */ });
var getDurationValue = function getDurationValue(_ref) {
  var minutes = _ref.minutes;
...
/***/ "./src/southwest/parser/getFare.ts":
/*!*****************************************!*\
  !*** ./src/southwest/parser/getFare.ts ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/southwest/parser/getFlightDetails.ts":
/*!**************************************************!*\
  !*** ./src/southwest/parser/getFlightDetails.ts ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var date_fns_tz__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! date-fns-tz */ "./node_modules/date-fns-tz/esm/format/index.js");
...
var getFlightDetails = function getFlightDetails(_ref) {
  var flight = _ref.flight;
...
/***/ "./src/southwest/parser/getFlightLegs.ts":
/*!***********************************************!*\
  !*** ./src/southwest/parser/getFlightLegs.ts ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/southwest/parser/getUnprocessedSearchResults.ts":
/*!*************************************************************!*\
  !*** ./src/southwest/parser/getUnprocessedSearchResults.ts ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getUnprocessedSearchResults": () => (/* binding */ getUnprocessedSearchResults)
/* harmony export */ });
/* harmony import */ var _getFare__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getFare */ "./src/southwest/parser/getFare.ts");
/* harmony import */ var _getFlightDetails__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./getFlightDetails */ "./src/southwest/parser/getFlightDetails.ts");


var getUnprocessedSearchResults = function getUnprocessedSearchResults(_ref) {
  var departures = _ref.departures,
      returns = _ref.returns;
  var roundtrip = returns.length > 0;
  var itineraries = [];
  departures.forEach(function (departureItem) {
    var departureFlight = (0,_getFlightDetails__WEBPACK_IMPORTED_MODULE_1__.getFlightDetails)({
      flight: departureItem
    });
    var departureFare = (0,_getFare__WEBPACK_IMPORTED_MODULE_0__.getFare)({
      flight: departureItem
    });
    ...
    if (roundtrip) {
      returns.forEach(function (returnItem) {
        ...
        itineraries.push({
          ...
          fare: "".concat(Number(departureFare) + Number(returnFare)),
          id: "".concat(departureFlight.id, "-").concat(returnFlight.id)
        });
      });
    } else {
      itineraries.push({
...
/***/ "./src/southwest/parser/parseFlights.ts":
/*!**********************************************!*\
  !*** ./src/southwest/parser/parseFlights.ts ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "parseFlights": () => (/* binding */ parseFlights)
/* harmony export */ });
...
var parseFlights = function parseFlights(searchResults) {
  if (!searchResults) {
    return;
  }

  var _searchResults$airPro = _slicedToArray(searchResults.airProducts, 2),
      departures = _searchResults$airPro[0],
      returns = _searchResults$airPro[1];
  ...
  var departureFlights = departures.details;
  var returnFlights = returns ? returns.details : [];
  var results = (0,_getUnprocessedSearchResults__WEBPACK_IMPORTED_MODULE_1__.getUnprocessedSearchResults)({
...
/***/ "./src/southwest/parser/parseSouthwestDateWithTimezone.ts":
/*!****************************************************************!*\
  !*** ./src/southwest/parser/parseSouthwestDateWithTimezone.ts ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "parseSouthwestDateWithTimezone": () => (/* binding */ parseSouthwestDateWithTimezone)
/* harmony export */ });
...
var parseSouthwestDateWithTimezone = function parseSouthwestDateWithTimezone(_ref) {
  var rawDate = _ref.rawDate;
  // Make sure you format with date-fns-tz to get the time in the timezone originally provided!
  var date = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.default)(rawDate);
  var match = rawDate.match(/[+|-]\d{2}:\d{2}$/);

  if (!match) {
    throw new TypeError("Unknown date format");
  }

  var timezone = match[0];
  return (0,date_fns_tz__WEBPACK_IMPORTED_MODULE_1__.default)(date, timezone);
};

/***/ }),

/***/ "./src/southwest/parser/setFlightIds.ts":
/*!**********************************************!*\
  !*** ./src/southwest/parser/setFlightIds.ts ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/southwest/ui/highlightFlightCard.ts":
/*!*************************************************!*\
  !*** ./src/southwest/ui/highlightFlightCard.ts ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/southwest/ui/removeFlightCardHighlight.ts":
/*!*******************************************************!*\
  !*** ./src/southwest/ui/removeFlightCardHighlight.ts ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/southwest/ui/scrollToFlightCard.ts":
/*!************************************************!*\
  !*** ./src/southwest/ui/scrollToFlightCard.ts ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/*!****************************************!*\
  ...
  \****************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _shared_utilities_isScraperFlag__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../shared/utilities/isScraperFlag */ "./src/shared/utilities/isScraperFlag.ts");
...
/* harmony import */ var _ui_clearSelections__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./ui/clearSelections */ "./src/southwest/ui/clearSelections.ts");
/* harmony import */ var _ui_highlightFlightCard__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./ui/highlightFlightCard */ "./src/southwest/ui/highlightFlightCard.ts");
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
...
chrome.runtime.onMessage.addListener( /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(function* (message) {
    ...
    switch (message.event) {
      case "BEGIN_PARSING":
        try {
          (0,_shared_utilities_isScraperFlag__WEBPACK_IMPORTED_MODULE_0__.setScraperFlag)();
      ...
      case "HIGHLIGHT_FLIGHT":
        ...
        yield (0,_ui_highlightFlightCard__WEBPACK_IMPORTED_MODULE_7__.highlightFlightCard)({
      ...
      case "CLEAR_SELECTION":
        (0,_ui_clearSelections__WEBPACK_IMPORTED_MODULE_6__.clearSelections)();
        chrome.runtime.sendMessage({
...
var getFlightResults = /*#__PURE__*/function () {
  ...
  return function getFlightResults() {
    return _ref2.apply(this, arguments);
  };
}();
})();
