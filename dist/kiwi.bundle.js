...
/***/ "./src/kiwi/parser/getAllLayovers.ts":
/*!*******************************************!*\
  !*** ./src/kiwi/parser/getAllLayovers.ts ***!
  \*******************************************/
...
/* harmony export */   "getAllLayovers": () => (/* binding */ getAllLayovers)
/* harmony export */ });
...
/* harmony import */ var _ui_closeModal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../ui/closeModal */ "./src/kiwi/ui/closeModal.ts");
/* harmony import */ var _ui_getLayoversDetailModal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../ui/getLayoversDetailModal */ "./src/kiwi/ui/getLayoversDetailModal.ts");
/* harmony import */ var _getFlightLayovers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./getFlightLayovers */ "./src/kiwi/parser/getFlightLayovers.ts");
...
/* harmony import */ var _shared_getFlightPenguinId__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../shared/getFlightPenguinId */ "./src/kiwi/shared/getFlightPenguinId.ts");
/* harmony import */ var _getAllLayovers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./getAllLayovers */ "./src/kiwi/parser/getAllLayovers.ts");
/* harmony import */ var _getFlightDetails__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./getFlightDetails */ "./src/kiwi/parser/getFlightDetails.ts");
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
...
var getFare = function getFare(flightCard) {
  var _fareContainer$textCo;

  var fareContainer = flightCard.querySelector(FARE_ELEMENT_SELECTOR);

  if (!fareContainer) {
    throw new _shared_errors__WEBPACK_IMPORTED_MODULE_0__.MissingElementLookupError("Unable to find fare container");
  }

  var fare = (_fareContainer$textCo = fareContainer.textContent) === null || _fareContainer$textCo === void 0 ? void 0 : _fareContainer$textCo.replace(/\s+/g, "");

  if (!fare) {
    throw new _shared_errors__WEBPACK_IMPORTED_MODULE_0__.MissingFieldParserError("Unable to extract fare from ".concat(fareContainer.textContent));
  }

  return fare;
};

var setFlightId = function setFlightId(flightCard, id) {
  flightCard.dataset.fpid = id;
};

/***/ }),

/***/ "./src/kiwi/parser/getFlightContainer.ts":
/*!***********************************************!*\
  !*** ./src/kiwi/parser/getFlightContainer.ts ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var getFlightContainer = /*#__PURE__*/function () {
  ...
  return function getFlightContainer() {
...
/***/ "./src/kiwi/parser/getFlightDetails.ts":
/*!*********************************************!*\
  !*** ./src/kiwi/parser/getFlightDetails.ts ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var getDuration = function getDuration(flightCard, flightType) {
  ...
  var durationContainer = durationContainers[index];
  var duration = durationContainer.textContent;
...
var getOperatingAirline = function getOperatingAirline(layovers) {
  var airlines = Array.from(new Set(layovers.map(function (layover) {
    return layover.operatingAirline;
  })));
...
var FLIGHT_SEGMENT_AIRLINE_CONTAINER_SELECTOR = "div[class*='SectorFlightCarrier']";
var FLIGHT_SEGMENT_DURATION_CONTAINER_SELECTOR = "div[class*='SectorFlightCell']";
var FLIGHT_SEGMENT_AIRPORT_CONTAINER_SELECTOR = "div[class*='SectorPlace']";
var FLIGHT_SEGMENT_AIRPORT_CITY_NAME_SELECTOR = "[class*='SectorPlaceText']";
var FLIGHT_SEGMENT_AIRPORT_NAME_SELECTOR = "p[class*='StyledText']";

var AIRPORT_REGEX = /*#__PURE__*/_wrapRegExp(/(.*)[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]+\(([0-9A-Za-z]{3})\)/, {
  airportName: 1,
  airportCode: 2
});

var getFlightLayovers = function getFlightLayovers(modal, flightType) {
...
var getLegSection = function getLegSection(modal, flightType) {
  var index = flightType === "RETURN" ? 1 : 0;
  ...
  return legsSections[index];
};

var getFlightSegments = function getFlightSegments(legSection) {
  var flightSegmentContainers = legSection.querySelectorAll(FLIGHT_SEGMENT_CONTAINER_SELECTOR);

  if (!flightSegmentContainers.length) {
    throw new _shared_errors__WEBPACK_IMPORTED_MODULE_0__.MissingElementLookupError("Unable to locate flight segment containers");
  }

  return Array.from(flightSegmentContainers).filter(function (flightSegmentContainer, index) {
    if (index % 2 === 0) {
      return flightSegmentContainer;
    }
  }).map(function (flightSegmentContainer) {
    return getFlightSegment(flightSegmentContainer);
  });
};

var getFlightSegment = function getFlightSegment(flightSegmentContainer) {
  var _getFlightSegmentTime = getFlightSegmentTimes(flightSegmentContainer),
      departureTime = _getFlightSegmentTime.departureTime,
      arrivalTime = _getFlightSegmentTime.arrivalTime;

  var operatingAirline = getAirlineName(flightSegmentContainer);

  var _getDuration = getDuration(flightSegmentContainer),
      durationText = _getDuration.durationText,
      durationInterval = _getDuration.durationInterval;

  var _getFlightSegmentAirp = getFlightSegmentAirports(flightSegmentContainer),
      departureAirport = _getFlightSegmentAirp.departureAirport,
      arrivalAirport = _getFlightSegmentAirp.arrivalAirport;
...
var getFlightSegmentTimes = function getFlightSegmentTimes(flightSegmentContainer) {
  var timeElements = flightSegmentContainer.querySelectorAll(FLIGHT_SEGMENT_TIME_CONTAINER_SELECTOR);

  if (timeElements.length !== 2) {
    throw new _shared_errors__WEBPACK_IMPORTED_MODULE_0__.MissingElementLookupError("Unable to find flight segment time cells");
  }

  var _timeElements = _slicedToArray(timeElements, 2),
      departureTimeContainer = _timeElements[0],
      arrivalTimeContainer = _timeElements[1];
...
var getDateTimeFromWrapper = function getDateTimeFromWrapper(container) {
  var timeElement = container.querySelector("time");
...
var getAirlineName = function getAirlineName(flightSegmentContainer) {
  var container = flightSegmentContainer.querySelector(FLIGHT_SEGMENT_AIRLINE_CONTAINER_SELECTOR);

  if (!container) {
    throw new _shared_errors__WEBPACK_IMPORTED_MODULE_0__.MissingElementLookupError("Unable to find airline container");
  }

  var image = container.querySelector("img");

  if (!image) {
    throw new _shared_errors__WEBPACK_IMPORTED_MODULE_0__.MissingElementLookupError("Unable to locate image in airline container");
  }

  var airlineName = image.title || image.alt;
...
var getDuration = function getDuration(flightSegmentContainer) {
  var container = flightSegmentContainer.querySelector(FLIGHT_SEGMENT_DURATION_CONTAINER_SELECTOR);

  if (!container) {
    throw new _shared_errors__WEBPACK_IMPORTED_MODULE_0__.MissingElementLookupError("Unable to find duration container");
  }

  var timeElement = container.querySelector("time");

  if (!timeElement) {
    throw new _shared_errors__WEBPACK_IMPORTED_MODULE_0__.MissingElementLookupError("Unable to locate duration datetime element");
  }

  var durationText = timeElement.textContent;

  if (!durationText) {
    throw new _shared_errors__WEBPACK_IMPORTED_MODULE_0__.MissingFieldParserError("Unable to extract duration");
  }

  var durationInterval = timeElement.dateTime;

  if (!durationInterval) {
    throw new _shared_errors__WEBPACK_IMPORTED_MODULE_0__.MissingFieldParserError("Unable to extract duration interval");
  }
...
var getFlightSegmentAirports = function getFlightSegmentAirports(flightSegmentContainer) {
  var airportContainers = flightSegmentContainer.querySelectorAll(FLIGHT_SEGMENT_AIRPORT_CONTAINER_SELECTOR);

  if (airportContainers.length !== 2) {
    throw new _shared_errors__WEBPACK_IMPORTED_MODULE_0__.MissingElementLookupError("Unable to find flight segment airport cells");
  }

  var _airportContainers = _slicedToArray(airportContainers, 2),
      departureAirportContainer = _airportContainers[0],
      arrivalAirportContainer = _airportContainers[1];
...
var getAirportDetails = function getAirportDetails(airportContainer) {
  var city = getAirportCity(airportContainer);

  var _getAirport = getAirport(airportContainer),
      name = _getAirport.name,
      code = _getAirport.code;
...
var getAirportCity = function getAirportCity(airportContainer) {
  var cityContainer = airportContainer.querySelector(FLIGHT_SEGMENT_AIRPORT_CITY_NAME_SELECTOR);

  if (!cityContainer) {
    throw new _shared_errors__WEBPACK_IMPORTED_MODULE_0__.MissingElementLookupError("Unable to find city container");
  }

  var city = cityContainer.textContent;

  if (!city) {
    throw new _shared_errors__WEBPACK_IMPORTED_MODULE_0__.MissingFieldParserError("Unable to extract city name");
  }

  return city;
};

var getAirport = function getAirport(airportContainer) {
  var airportNameContainer = airportContainer.querySelector(FLIGHT_SEGMENT_AIRPORT_NAME_SELECTOR);

  if (!airportNameContainer) {
    throw new _shared_errors__WEBPACK_IMPORTED_MODULE_0__.MissingElementLookupError("Unable to find airport name container");
  }

  var airportText = airportNameContainer.textContent;

  if (!airportText) {
    throw new _shared_errors__WEBPACK_IMPORTED_MODULE_0__.MissingFieldParserError("Unable to extract airport name");
  }

  var matchInfo = airportText.match(AIRPORT_REGEX);

  if (!matchInfo) {
    throw new Error("".concat(airportText, " does not match regex"));
  }

  var airportInfo = matchInfo.groups;

  if (!airportInfo) {
    throw new Error("Unknown groups: ".concat(airportInfo));
  }
  ...
  return {
    name: airportInfo.airportName,
    code: airportInfo.airportCode
  };
};
...
/* harmony export */ });
/* harmony import */ var _sendFlights__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sendFlights */ "./src/kiwi/parser/sendFlights.ts");
      ...
      var _ref2 = _asyncToGenerator(function* (mutations) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            flightCards = flightCards.concat(Array.from(mutation.addedNodes).filter(function (element) {
...
/***/ "./src/kiwi/parser/sendFlights.ts":
/*!****************************************!*\
  !*** ./src/kiwi/parser/sendFlights.ts ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _getFlight__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./getFlight */ "./src/kiwi/parser/getFlight.ts");
function _createForOfIteratorHelper(o, allowArrayLike) { var it; if (typeof Symbol === "undefined" || o[Symbol.iterator] == null) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = o[Symbol.iterator](); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }
...
var sendFlights = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(function* (_ref) {
    ...
    if (flights.length) {
      (0,_shared_events__WEBPACK_IMPORTED_MODULE_0__.sendFlightsEvent)("kiwi", flights);
    }
  });
...
var shouldSkipCard = function shouldSkipCard(flightCard) {
  var denyListTerms = ["travel hack", "no-checked-bag"];
  var ignoreIfMissing = ["show details"];
  return denyListTerms.some(function (term) {
    var _flightCard$textConte;

    return (_flightCard$textConte = flightCard.textContent) === null || _flightCard$textConte === void 0 ? void 0 : _flightCard$textConte.toLowerCase().includes(term);
  }) || ignoreIfMissing.some(function (term) {
    var _flightCard$textConte2;
...
/***/ "./src/kiwi/shared/getFlightPenguinId.ts":
/*!***********************************************!*\
  !*** ./src/kiwi/shared/getFlightPenguinId.ts ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var MODAL_SELECTOR = "[data-test='ResultCardModal']";
var MODAL_CLOSE_BUTTON_SELECTOR = "button[data-test='ModalCloseButton']";
var closeModal = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(function* (modal) {
    var closeButton = modal.querySelector(MODAL_CLOSE_BUTTON_SELECTOR);

    if (!closeButton) {
      throw new _shared_errors__WEBPACK_IMPORTED_MODULE_0__.MissingElementLookupError("Unable to find modal close button");
    }

    closeButton.click();
    yield (0,_shared_utilities_waitFor__WEBPACK_IMPORTED_MODULE_1__.waitForDisappearance)(30000, MODAL_SELECTOR);
  });

  return function closeModal(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
var findFlightCard = function findFlightCard(id) {
  ...
  if (!flightCard) {
    throw new _shared_errors__WEBPACK_IMPORTED_MODULE_0__.MissingElementLookupError("Unable to find flight with id ".concat(id));
  }
...
/***/ "./src/kiwi/ui/getLayoversDetailModal.ts":
/*!***********************************************!*\
  !*** ./src/kiwi/ui/getLayoversDetailModal.ts ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getLayoversDetailModal": () => (/* binding */ getLayoversDetailModal)
/* harmony export */ });
/* harmony import */ var _shared_errors__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../shared/errors */ "./src/shared/errors.ts");
/* harmony import */ var _shared_utilities_waitFor__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../shared/utilities/waitFor */ "./src/shared/utilities/waitFor.ts");
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
...
var TOGGLE_WRAPPER_SELECTOR = "[data-test='Journey-toggle']";
var MODAL_SELECTOR = "[data-test='ResultCardModal']";
var getLayoversDetailModal = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(function* (flightCard) {
    var toggleWrapper = flightCard.querySelector(TOGGLE_WRAPPER_SELECTOR);

    if (!toggleWrapper) {
      throw new _shared_errors__WEBPACK_IMPORTED_MODULE_0__.MissingElementLookupError("Unable to find toggle wrapper");
    }

    toggleWrapper.click();
    return yield (0,_shared_utilities_waitFor__WEBPACK_IMPORTED_MODULE_1__.waitForAppearance)(30000, MODAL_SELECTOR);
  });

  return function getLayoversDetailModal(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
/***/ "./src/kiwi/ui/highlightFlightCard.ts":
/*!********************************************!*\
  !*** ./src/kiwi/ui/highlightFlightCard.ts ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _findFlightCard__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./findFlightCard */ "./src/kiwi/ui/findFlightCard.ts");
/* harmony import */ var _removeFlightCardHighlight__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./removeFlightCardHighlight */ "./src/kiwi/ui/removeFlightCardHighlight.ts");
/* harmony import */ var _scrollToFlightCard__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./scrollToFlightCard */ "./src/kiwi/ui/scrollToFlightCard.ts");
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
...
var highlightFlightCard = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(function* (selectedFlightId) {
    ...
    (0,_scrollToFlightCard__WEBPACK_IMPORTED_MODULE_3__.scrollToFlightCard)(flightCard);
  });
...
var loadAllFlights = /*#__PURE__*/function () {
  ...
  return function loadAllFlights() {
    return _ref.apply(this, arguments);
  };
}();
...
var waitForLoaderDisappearance = /*#__PURE__*/function () {
  ...
  return function waitForLoaderDisappearance() {
    return _ref2.apply(this, arguments);
  };
}();

var getShowMoreButton = function getShowMoreButton(flightContainer) {
  var button = Array.from(flightContainer.querySelectorAll("button")).slice(-1)[0];
...
/***/ "./src/kiwi/ui/removeFlightCardHighlight.ts":
/*!**************************************************!*\
  !*** ./src/kiwi/ui/removeFlightCardHighlight.ts ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "removeFlightCardHighlight": () => (/* binding */ removeFlightCardHighlight)
/* harmony export */ });
/* harmony import */ var _shared_ui_manageSelectionHighlights__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../shared/ui/manageSelectionHighlights */ "./src/shared/ui/manageSelectionHighlights.ts");

var removeFlightCardHighlight = function removeFlightCardHighlight() {
...
/***/ "./src/kiwi/ui/scrollToFlightCard.ts":
/*!*******************************************!*\
  !*** ./src/kiwi/ui/scrollToFlightCard.ts ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "sendOpenExtension": () => (/* reexport safe */ _sendOpenExtension__WEBPACK_IMPORTED_MODULE_3__.sendOpenExtension),
/* harmony export */   "sendReturnFlightsEvent": () => (/* reexport safe */ _sendReturnFlights__WEBPACK_IMPORTED_MODULE_4__.sendReturnFlightsEvent),
/* harmony export */   "sendSelectedFlight": () => (/* reexport safe */ _sendSelectedFlight__WEBPACK_IMPORTED_MODULE_5__.sendSelectedFlight),
/* harmony export */   "sendHighlightTab": () => (/* reexport safe */ _sendHighlightTab__WEBPACK_IMPORTED_MODULE_6__.sendHighlightTab),
/* harmony export */   "sendScraperComplete": () => (/* reexport safe */ _sendScraperComplete__WEBPACK_IMPORTED_MODULE_7__.sendScraperComplete)
/* harmony export */ });
...
/* harmony import */ var _sendOpenExtension__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./sendOpenExtension */ "./src/shared/events/sendOpenExtension.ts");
/* harmony import */ var _sendReturnFlights__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./sendReturnFlights */ "./src/shared/events/sendReturnFlights.ts");
/* harmony import */ var _sendSelectedFlight__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./sendSelectedFlight */ "./src/shared/events/sendSelectedFlight.ts");
/* harmony import */ var _sendHighlightTab__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./sendHighlightTab */ "./src/shared/events/sendHighlightTab.ts");
/* harmony import */ var _sendScraperComplete__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./sendScraperComplete */ "./src/shared/events/sendScraperComplete.ts");
...
/***/ "./src/shared/events/sendOpenExtension.ts":
/*!************************************************!*\
  !*** ./src/shared/events/sendOpenExtension.ts ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "sendOpenExtension": () => (/* binding */ sendOpenExtension)
/* harmony export */ });
function sendOpenExtension() {
...
/* harmony import */ var _parser_getFlightContainer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./parser/getFlightContainer */ "./src/kiwi/parser/getFlightContainer.ts");
/* harmony import */ var _parser_observer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./parser/observer */ "./src/kiwi/parser/observer.ts");
/* harmony import */ var _shared_getFlightPenguinId__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./shared/getFlightPenguinId */ "./src/kiwi/shared/getFlightPenguinId.ts");
/* harmony import */ var _ui_highlightFlightCard__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./ui/highlightFlightCard */ "./src/kiwi/ui/highlightFlightCard.ts");
/* harmony import */ var _ui_loadAllFlights__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./ui/loadAllFlights */ "./src/kiwi/ui/loadAllFlights.ts");
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
    ...
    switch (message.event) {
      case "BEGIN_PARSING":
        try {
          ...
          if (flightContainer) {
            yield (0,_ui_loadAllFlights__WEBPACK_IMPORTED_MODULE_6__.loadAllFlights)();
          }
          ...
          (0,_shared_events__WEBPACK_IMPORTED_MODULE_0__.sendFailedScraper)("kiwi", error, "DEPARTURE");
        }
...
var attachObserver = /*#__PURE__*/function () {
  ...
  return function attachObserver(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
})();
