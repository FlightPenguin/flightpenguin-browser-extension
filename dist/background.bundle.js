...
var getAuthToken = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(function* () {
    return yield getAuthTokenPromise();
  });
...
var getAuthTokenPromise = function getAuthTokenPromise() {
...
/* harmony export */ });
/* harmony import */ var _background_constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../background/constants */ "./src/background/constants.ts");

function getSubscriptionValidity(accessToken) {
  return fetch("".concat(_background_constants__WEBPACK_IMPORTED_MODULE_0__.API_HOST, "/api/subscription/status"), {
    method: "GET",
    credentials: "include",
    mode: "cors",
    headers: new Headers({
...
var ProviderManager = /*#__PURE__*/function () {
  ...
  _createClass(ProviderManager, [{
    ...
    key: "getFormCabinValue",
    value: function getFormCabinValue() {
      var _this$formData;

      return ((_this$formData = this.formData) === null || _this$formData === void 0 ? void 0 : _this$formData.cabin) || "econ";
    }
  }, {
    ...
    key: "setParsing",
    value: function setParsing(providerName, searchType) {
    ...
    value: function searchForResults(formData, windowConfig) {
      ...
      var promises = this.knownProviders.map(function (provider) {
        ...
        return _this9.createWindow(url, provider, windowConfig, message);
      });
      Promise.all(promises).then(function () {
        // update again for chrome on windows, to move results window to foreground
        _this9.setPrimaryTabAsFocus();
      });
    }
  }, {
    ...
    value: function sendMessageToIndexPage(message) {
      ...
      var url = "chrome-extension://".concat(chrome.runtime.id, "/index.html");
      chrome.tabs.query({
        url: url
      }, function (tabs) {
        if (tabs && tabs.length) {
          ...
          var primaryTabId = (_tabs$ = tabs[0]) === null || _tabs$ === void 0 ? void 0 : _tabs$.id;
    ...
    key: "incrementParsingAttempts",
    value: function incrementParsingAttempts(providerName) {
      this.state[providerName].attempts += 1;
    }
  }, {
    key: "retry",
    value: function retry(providerName, windowConfig) {
      var _this10 = this;

      this.closeWindow(providerName);

      if (this.state[providerName].attempts < 2 && !!this.formData) {
        var url = providerURLBaseMap[providerName](this.formData);
        var message = {
          event: "BEGIN_PARSING",
          message: this.formData
        };
        var promise = this.createWindow(url, providerName, windowConfig, message);
        promise.then(function () {
          _this10.setPrimaryTabAsFocus();
        });
        return true;
      } else {
        return false;
    ...
    key: "setPrimaryTabAsFocus",
    value: function setPrimaryTabAsFocus() {
      /*
      ...
      chrome.tabs.query({
        ...
        if (tabs && tabs.length) {
          ...
          if (primaryTab.id) {
            chrome.tabs.update(primaryTab.id, {
              active: true
            }, function (tab) {
              if (tab !== null && tab !== void 0 && tab.windowId) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "EXTENSION_URL": () => (/* binding */ EXTENSION_URL),
...
/* harmony export */ });
var EXTENSION_URL = "chrome-extension://nofndgfpjopdpbcejgdpikmpdehlekac/index.html";
...
var API_HOST =  true ? "http://localhost:3000" : 0;
...
var getRoundtripProviderReturns = function getRoundtripProviderReturns(departure, providerManager) {
  ...
  var returnList = (0,_dataModels__WEBPACK_IMPORTED_MODULE_0__.sortFlights)((0,_dataModels__WEBPACK_IMPORTED_MODULE_0__.findReturnFlights)(departure, itineraries), itineraries, providerManager.getFormCabinValue());
  providerManager.addReturns(returnList);
  var message = {
    event: "RETURN_FLIGHTS_FOR_CLIENT",
    flights: {
      departureList: (0,_dataModels__WEBPACK_IMPORTED_MODULE_0__.sortFlights)(providerManager.getDepartures(), itineraries, providerManager.getFormCabinValue()),
...
var handleFlightResultsReceived = function handleFlightResultsReceived(providerManager, flights, providerName) {
  ...
  if (setSuccessful) {
    ...
    var departuresToSend = (0,_dataModels__WEBPACK_IMPORTED_MODULE_0__.sortFlights)(updatedDepartures, updatedItineraries, providerManager.getFormCabinValue());
    var nextMessage = {
      event: "FLIGHT_RESULTS_FOR_CLIENT",
      flights: {
        departureList: departuresToSend,
        itins: updatedItineraries,
        returnList: (0,_dataModels__WEBPACK_IMPORTED_MODULE_0__.sortFlights)(providerManager.getReturns(), updatedItineraries, providerManager.getFormCabinValue()),
        updatedAt: new Date()
      },
      formData: providerManager.getFormData()
    };
...
var handleFlightReturnResultsReceived = function handleFlightReturnResultsReceived(providerManager, flights, providerName) {
  ...
  if (setSuccessful) {
    ...
    var returnList = (0,_dataModels__WEBPACK_IMPORTED_MODULE_0__.sortFlights)(Object.values(returns), allItins, providerManager.getFormCabinValue()); // TODO dedup returns

    providerManager.addReturns(returnList);
    var nextMessage = {
      event: "RETURN_FLIGHTS_FOR_CLIENT",
      flights: {
        departureList: (0,_dataModels__WEBPACK_IMPORTED_MODULE_0__.sortFlights)(providerManager.getDepartures(), allItins, providerManager.getFormCabinValue()),
        returnList: providerManager.getReturns(),
        itins: itineraries,
        updatedAt: new Date()
      },
...
/* harmony export */   "handleFlightResultsReceived": () => (/* reexport safe */ _flightResultsReceived__WEBPACK_IMPORTED_MODULE_2__.handleFlightResultsReceived),
/* harmony export */   "handleFlightReturnResultsReceived": () => (/* reexport safe */ _flightReturnResultsReceived__WEBPACK_IMPORTED_MODULE_3__.handleFlightReturnResultsReceived),
/* harmony export */   "handleFocusWebpage": () => (/* reexport safe */ _focusWebpage__WEBPACK_IMPORTED_MODULE_4__.handleFocusWebpage),
/* harmony export */   "handleFormDataReceived": () => (/* reexport safe */ _formDataReceived__WEBPACK_IMPORTED_MODULE_5__.handleFormDataReceived),
/* harmony export */   "handleHighlightTab": () => (/* reexport safe */ _highlightTab__WEBPACK_IMPORTED_MODULE_6__.handleHighlightTab),
/* harmony export */   "handleIndexUnloaded": () => (/* reexport safe */ _indexUnloaded__WEBPACK_IMPORTED_MODULE_7__.handleIndexUnloaded),
/* harmony export */   "handleNoFlightsFound": () => (/* reexport safe */ _noFlightsFound__WEBPACK_IMPORTED_MODULE_8__.handleNoFlightsFound),
/* harmony export */   "handleOpenExtensionRequest": () => (/* reexport safe */ _openExtension__WEBPACK_IMPORTED_MODULE_9__.handleOpenExtensionRequest),
...
/* harmony export */   "handleUpdateRequest": () => (/* reexport safe */ _updateRequest__WEBPACK_IMPORTED_MODULE_13__.handleUpdateRequest)
/* harmony export */ });
...
/* harmony import */ var _flightResultsReceived__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./flightResultsReceived */ "./src/background/eventHandlers/flightResultsReceived.ts");
/* harmony import */ var _flightReturnResultsReceived__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./flightReturnResultsReceived */ "./src/background/eventHandlers/flightReturnResultsReceived.ts");
/* harmony import */ var _focusWebpage__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./focusWebpage */ "./src/background/eventHandlers/focusWebpage.ts");
/* harmony import */ var _formDataReceived__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./formDataReceived */ "./src/background/eventHandlers/formDataReceived.ts");
/* harmony import */ var _highlightTab__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./highlightTab */ "./src/background/eventHandlers/highlightTab.ts");
/* harmony import */ var _indexUnloaded__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./indexUnloaded */ "./src/background/eventHandlers/indexUnloaded.ts");
...
/* harmony import */ var _openExtension__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./openExtension */ "./src/background/eventHandlers/openExtension.ts");
...
/* harmony import */ var _updateRequest__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./updateRequest */ "./src/background/eventHandlers/updateRequest.ts");
...
/***/ "./src/background/eventHandlers/openExtension.ts":
/*!*******************************************************!*\
  !*** ./src/background/eventHandlers/openExtension.ts ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "handleOpenExtensionRequest": () => (/* binding */ handleOpenExtensionRequest)
/* harmony export */ });
/* harmony import */ var _state_openExtension__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../state/openExtension */ "./src/background/state/openExtension.ts");
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }

function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }


var MessageSender = chrome.runtime.MessageSender;
var handleOpenExtensionRequest = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(function* (sender) {
    console.log("User requested extension load");
    yield (0,_state_openExtension__WEBPACK_IMPORTED_MODULE_0__.openExtension)();
    var tab = sender.tab;
  ...
  return function handleOpenExtensionRequest(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
/* harmony export */ });
var handleScraperFailed = function handleScraperFailed(providerManager, providerName, errorDescription, searchType, windowConfig) {
  var close = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : true;
  providerManager.setFailed(providerName, searchType);
  var isRetrying = providerManager.retry(providerName, windowConfig);
...
/***/ "./src/background/eventHandlers/updateRequest.ts":
/*!*******************************************************!*\
  !*** ./src/background/eventHandlers/updateRequest.ts ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "handleUpdateRequest": () => (/* binding */ handleUpdateRequest)
/* harmony export */ });
var handleUpdateRequest = function handleUpdateRequest() {
...
/* harmony export */ });
/* harmony import */ var _openExtension__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./openExtension */ "./src/background/state/openExtension.ts");
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
...
var ExtensionInstalledHandler = function ExtensionInstalledHandler() {
  chrome.runtime.onInstalled.addListener( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(function* (details) {
      ...
      console.log(details);
      yield (0,_openExtension__WEBPACK_IMPORTED_MODULE_0__.openExtension)();
    });
...
var ExtensionOpenedHandler = function ExtensionOpenedHandler() {
  chrome.browserAction.onClicked.addListener(function () {
    (0,_openExtension__WEBPACK_IMPORTED_MODULE_0__.openExtension)();
  });
};
...
/***/ "./src/background/state/ExtensionUpdateAvailableHandler.ts":
/*!*****************************************************************!*\
  !*** ./src/background/state/ExtensionUpdateAvailableHandler.ts ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ExtensionUpdateAvailableHandler": () => (/* binding */ ExtensionUpdateAvailableHandler)
/* harmony export */ });
var ExtensionUpdateAvailableHandler = function ExtensionUpdateAvailableHandler(providerManager) {
...
/* harmony export */   "ExtensionUpdateAvailableHandler": () => (/* reexport safe */ _ExtensionUpdateAvailableHandler__WEBPACK_IMPORTED_MODULE_3__.ExtensionUpdateAvailableHandler),
/* harmony export */   "isExtensionOpen": () => (/* reexport safe */ _isExtensionOpen__WEBPACK_IMPORTED_MODULE_4__.isExtensionOpen)
/* harmony export */ });
...
/* harmony import */ var _ExtensionUpdateAvailableHandler__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ExtensionUpdateAvailableHandler */ "./src/background/state/ExtensionUpdateAvailableHandler.ts");
...
/***/ "./src/background/state/openExtension.ts":
/*!***********************************************!*\
  !*** ./src/background/state/openExtension.ts ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "openExtension": () => (/* binding */ openExtension)
/* harmony export */ });
...
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../constants */ "./src/background/constants.ts");
/* harmony import */ var _isExtensionOpen__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./isExtensionOpen */ "./src/background/state/isExtensionOpen.ts");
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
...
var openExtension = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(function* () {
    try {
      disableExtension();
      var token = yield (0,_auth_getAuthToken__WEBPACK_IMPORTED_MODULE_1__.getAuthToken)();
      ...
      if (status) {
        ...
        chrome.tabs.create({
          url: _constants__WEBPACK_IMPORTED_MODULE_3__.API_HOST
        });
      }
    } catch (e) {
      chrome.tabs.create({
...
var updateExtensionIfRequired = function updateExtensionIfRequired() {
...
/* harmony import */ var _background_constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../background/constants */ "./src/background/constants.ts");
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
...
var getNearbyAirportData = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(function* (_ref) {
    ...
    var response = yield fetch("".concat(_background_constants__WEBPACK_IMPORTED_MODULE_1__.API_HOST, "/api/airport/location?latitude=").concat(position.coords.latitude, "&longitude=").concat(position.coords.longitude, "&page=").concat(page), {
      method: "GET",
      credentials: "include",
      mode: "cors",
      headers: new Headers({
...
/* harmony export */ });
/* harmony import */ var shared_utilities_getCalculatedDuration__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! shared/utilities/getCalculatedDuration */ "./src/shared/utilities/getCalculatedDuration.ts");
/* harmony import */ var shared_utilities_pain_getPain__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! shared/utilities/pain/getPain */ "./src/shared/utilities/pain/getPain.ts");
/* harmony import */ var _shared_nameMaps_airlineMap_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./shared/nameMaps/airlineMap.js */ "./src/shared/nameMaps/airlineMap.js");
/* harmony import */ var _shared_nameMaps_regionalAirlines_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./shared/nameMaps/regionalAirlines.js */ "./src/shared/nameMaps/regionalAirlines.js");
/* harmony import */ var _utilityFunctions_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utilityFunctions.js */ "./src/utilityFunctions.js");
...
function Flight(fromTime, fromTimeDetails, fromDateTime, fromLocalTime, toTime, toTimeDetails, toDateTime, toLocalTime, toLocalDateTime, operatingAirline, marketingAirline, duration, layovers, timezoneOffset) {
  ...
  if (opAirline) {
    ...
    if ((0,_shared_nameMaps_regionalAirlines_js__WEBPACK_IMPORTED_MODULE_3__.default)(opAirline) || isPartiallyOperated) {
...
function cleanupAirline(airline) {
  ...
  if (airlines.length === 1) {
    ...
    shortAirlineName = airlines.map(function (airline) {
      return _shared_nameMaps_airlineMap_js__WEBPACK_IMPORTED_MODULE_2__.default.getAirlineName(airline.replace("  ", " "));
    }).join(", ");
  }
  ...
  if (this.layovers.length) {
    ...
    for (var i = 0; i < layovers.length - 1; i++) {
      ...
      var fromTime = previousFlight.toTime,
          ...
          fromLocalTime = previousFlight.toLocalTime,
          fromTimeDetails = previousFlight.toTimeDetails;
      var toTime = nextFlight.fromTime,
          to = nextFlight.from,
          toLocalTime = nextFlight.fromLocalTime,
          toTimeDetails = nextFlight.fromTimeDetails;

      var _getCalculatedDuratio = (0,shared_utilities_getCalculatedDuration__WEBPACK_IMPORTED_MODULE_0__.getCalculatedDuration)(fromTimeDetails, toTimeDetails),
          durationInMinutes = _getCalculatedDuratio.durationInMinutes,
          duration = _getCalculatedDuratio.duration;

      layoversWithStops.push(previousFlight);
      layoversWithStops.push({
        fromTime: fromTime,
        fromTimeDetails: fromTimeDetails,
        fromLocalTime: fromLocalTime,
        toTime: toTime,
        toTimeDetails: toTimeDetails,
...
function sortFlights(flights, itins, cabin) {
  for (var _i = 0, _Object$entries = Object.entries(flights); _i < _Object$entries.length; _i++) {
    ...
    v.pain = (0,shared_utilities_pain_getPain__WEBPACK_IMPORTED_MODULE_1__.getPain)(price, cabin, v.layovers);
  }
...
/***/ "./src/shared/utilities/getCalculatedDuration.ts":
/*!*******************************************************!*\
  !*** ./src/shared/utilities/getCalculatedDuration.ts ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getCalculatedDuration": () => (/* binding */ getCalculatedDuration)
/* harmony export */ });
var getCalculatedDuration = function getCalculatedDuration(fromTimeDetails, toTimeDetails) {
  var endHours = toTimeDetails.hours;

  while (fromTimeDetails.hours > endHours || fromTimeDetails.hours === endHours && fromTimeDetails.minutes > toTimeDetails.minutes) {
    endHours += 24;
  }

  var durationInMinutes = endHours * 60 + toTimeDetails.minutes - (fromTimeDetails.hours * 60 + fromTimeDetails.minutes);
  var durationHours = Math.floor(durationInMinutes / 60);
  var durationMinutes = durationInMinutes - durationHours * 60;
  var duration;

  if (durationHours && !durationMinutes) {
    duration = "".concat(durationHours, "h");
  } else {
    duration = durationHours ? "".concat(durationHours, "h ").concat(durationMinutes, "m") : "".concat(durationMinutes, "m");
  }
...
/***/ "./src/shared/utilities/pain/duration/getCabinMultiplier.ts":
/*!******************************************************************!*\
  !*** ./src/shared/utilities/pain/duration/getCabinMultiplier.ts ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getCabinMultiplier": () => (/* binding */ getCabinMultiplier)
/* harmony export */ });
var getCabinMultiplier = function getCabinMultiplier(cabin) {
...
/***/ "./src/shared/utilities/pain/duration/getCostPerMinute.ts":
/*!****************************************************************!*\
  !*** ./src/shared/utilities/pain/duration/getCostPerMinute.ts ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getCostPerMinute": () => (/* binding */ getCostPerMinute)
/* harmony export */ });
var getCostPerMinute = function getCostPerMinute(multiplier) {
  var costPerHour = 15 * multiplier;
  return costPerHour / 60;
};

/***/ }),

/***/ "./src/shared/utilities/pain/duration/getDurationCost.ts":
/*!***************************************************************!*\
  !*** ./src/shared/utilities/pain/duration/getDurationCost.ts ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getDurationCost": () => (/* binding */ getDurationCost)
/* harmony export */ });
/* harmony import */ var _getCabinMultiplier__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getCabinMultiplier */ "./src/shared/utilities/pain/duration/getCabinMultiplier.ts");
/* harmony import */ var _getCostPerMinute__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./getCostPerMinute */ "./src/shared/utilities/pain/duration/getCostPerMinute.ts");
/* harmony import */ var _getSmoothDuration__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./getSmoothDuration */ "./src/shared/utilities/pain/duration/getSmoothDuration.ts");



var getDurationCost = function getDurationCost(duration, cabin, multiplier) {
  var smoothedDuration = (0,_getSmoothDuration__WEBPACK_IMPORTED_MODULE_2__.getSmoothDuration)(duration);
  var cabinMultiplier = (0,_getCabinMultiplier__WEBPACK_IMPORTED_MODULE_0__.getCabinMultiplier)(cabin);
  var costPerMinute = (0,_getCostPerMinute__WEBPACK_IMPORTED_MODULE_1__.getCostPerMinute)(multiplier);
  return smoothedDuration * cabinMultiplier * costPerMinute;
};

/***/ }),

/***/ "./src/shared/utilities/pain/duration/getSmoothDuration.ts":
/*!*****************************************************************!*\
  !*** ./src/shared/utilities/pain/duration/getSmoothDuration.ts ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getSmoothDuration": () => (/* binding */ getSmoothDuration)
/* harmony export */ });
...
var getSmoothDuration = function getSmoothDuration(duration) {
  /*
   ...
   */
  var durationInMinutes = (0,_utilityFunctions__WEBPACK_IMPORTED_MODULE_0__.convertDurationToMinutes)(duration);
  var stepSize = getStepSize(durationInMinutes);
  var steps = Math.floor(durationInMinutes / stepSize);
  return steps * stepSize;
};

var getStepSize = function getStepSize(durationInMinutes) {
...
/***/ "./src/shared/utilities/pain/getPain.ts":
/*!**********************************************!*\
  !*** ./src/shared/utilities/pain/getPain.ts ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getPain": () => (/* binding */ getPain)
/* harmony export */ });
/* harmony import */ var _layovers_getLayoversCost__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./layovers/getLayoversCost */ "./src/shared/utilities/pain/layovers/getLayoversCost.ts");

var getPain = function getPain(fare, cabin, layovers) {
  var durationCost = (0,_layovers_getLayoversCost__WEBPACK_IMPORTED_MODULE_0__.getLayoversCost)(layovers, cabin);
  return Math.pow(fare, 1.05) + durationCost;
};

/***/ }),

/***/ "./src/shared/utilities/pain/layovers/getFauxDate.ts":
/*!***********************************************************!*\
  !*** ./src/shared/utilities/pain/layovers/getFauxDate.ts ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getFauxDate": () => (/* binding */ getFauxDate)
/* harmony export */ });
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/addHours/index.js");
...
var getFauxDate = function getFauxDate(timeDetails) {
  ...
  var fauxDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.default)();
  fauxDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.default)(fauxDate, timeDetails.hours);
  fauxDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.default)(fauxDate, timeDetails.minutes);
  return fauxDate;
};

/***/ }),

/***/ "./src/shared/utilities/pain/layovers/getLayoverCost.ts":
/*!**************************************************************!*\
  !*** ./src/shared/utilities/pain/layovers/getLayoverCost.ts ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getLayoverCost": () => (/* binding */ getLayoverCost)
/* harmony export */ });
/* harmony import */ var _duration_getDurationCost__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../duration/getDurationCost */ "./src/shared/utilities/pain/duration/getDurationCost.ts");
/* harmony import */ var _getLayoverMultiplier__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./getLayoverMultiplier */ "./src/shared/utilities/pain/layovers/getLayoverMultiplier.ts");


var getLayoverCost = function getLayoverCost(layover, cabin) {
  return (0,_duration_getDurationCost__WEBPACK_IMPORTED_MODULE_0__.getDurationCost)(layover.duration, cabin, (0,_getLayoverMultiplier__WEBPACK_IMPORTED_MODULE_1__.getLayoverMultiplier)(layover));
};

/***/ }),

/***/ "./src/shared/utilities/pain/layovers/getLayoverMultiplier.ts":
/*!********************************************************************!*\
  !*** ./src/shared/utilities/pain/layovers/getLayoverMultiplier.ts ***!
  \********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getLayoverMultiplier": () => (/* binding */ getLayoverMultiplier)
/* harmony export */ });
/* harmony import */ var _utilityFunctions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../utilityFunctions */ "./src/utilityFunctions.js");
/* harmony import */ var _getFauxDate__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./getFauxDate */ "./src/shared/utilities/pain/layovers/getFauxDate.ts");
/* harmony import */ var _isAirportChange__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./isAirportChange */ "./src/shared/utilities/pain/layovers/isAirportChange.ts");
/* harmony import */ var _isAwfulCarrier__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./isAwfulCarrier */ "./src/shared/utilities/pain/layovers/isAwfulCarrier.ts");
/* harmony import */ var _isLong__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./isLong */ "./src/shared/utilities/pain/layovers/isLong.ts");
/* harmony import */ var _isOvernight__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./isOvernight */ "./src/shared/utilities/pain/layovers/isOvernight.ts");
/* harmony import */ var _isShort__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./isShort */ "./src/shared/utilities/pain/layovers/isShort.ts");
...
var getLayoverMultiplier = function getLayoverMultiplier(layover) {
  var multiplier = 1;

  if ((0,_isAwfulCarrier__WEBPACK_IMPORTED_MODULE_3__.isAwfulCarrier)(layover)) {
  ...
  if ((0,_isAirportChange__WEBPACK_IMPORTED_MODULE_2__.isAirportChange)(layover)) {
    // Changing airports is an awful experience.  Massive penalty!
    multiplier += 4;
  }

  var startTimeDetails = (0,_utilityFunctions__WEBPACK_IMPORTED_MODULE_0__.getTimeDetails)(layover.fromTime);
  var fauxStartDate = (0,_getFauxDate__WEBPACK_IMPORTED_MODULE_1__.getFauxDate)(startTimeDetails);
  var endTimeDetails = (0,_utilityFunctions__WEBPACK_IMPORTED_MODULE_0__.getTimeDetails)(layover.toTime);
  var fauxEndDate = (0,_getFauxDate__WEBPACK_IMPORTED_MODULE_1__.getFauxDate)(endTimeDetails);
  var overnight = (0,_isOvernight__WEBPACK_IMPORTED_MODULE_5__.isOvernight)(startTimeDetails, endTimeDetails);
  ...
  if ((0,_isShort__WEBPACK_IMPORTED_MODULE_6__.isShort)(fauxStartDate, fauxEndDate, overnight)) {
    // Hoofing it around in a large airport in a short time, especially if delays hit can ruin a flight/connection.
    multiplier += 1;
  }

  if ((0,_isLong__WEBPACK_IMPORTED_MODULE_4__.isLong)(fauxStartDate, fauxEndDate, overnight)) {
...
/***/ "./src/shared/utilities/pain/layovers/getLayoversCost.ts":
/*!***************************************************************!*\
  !*** ./src/shared/utilities/pain/layovers/getLayoversCost.ts ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getLayoversCost": () => (/* binding */ getLayoversCost)
/* harmony export */ });
/* harmony import */ var _getLayoverCost__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getLayoverCost */ "./src/shared/utilities/pain/layovers/getLayoverCost.ts");

var getLayoversCost = function getLayoversCost(layovers, cabin) {
  var durationCost = 0;
  layovers.forEach(function (layover) {
    durationCost += (0,_getLayoverCost__WEBPACK_IMPORTED_MODULE_0__.getLayoverCost)(layover, cabin);
  });
  var layoverStops = layovers.filter(function (layover) {
    return layover.isLayoverStop;
  });
  var layoverCountMultiplier = Number("1.0".concat(layoverStops.length));
  return Math.pow(durationCost, layoverCountMultiplier);
};

/***/ }),

/***/ "./src/shared/utilities/pain/layovers/isAirportChange.ts":
/*!***************************************************************!*\
  !*** ./src/shared/utilities/pain/layovers/isAirportChange.ts ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "isAirportChange": () => (/* binding */ isAirportChange)
/* harmony export */ });
var isAirportChange = function isAirportChange(layover) {
  return layover.from !== layover.to;
};

/***/ }),

/***/ "./src/shared/utilities/pain/layovers/isAwfulCarrier.ts":
/*!**************************************************************!*\
  !*** ./src/shared/utilities/pain/layovers/isAwfulCarrier.ts ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "isAwfulCarrier": () => (/* binding */ isAwfulCarrier)
/* harmony export */ });
var AWFUL_CARRIERS = [// lowercase only key words
"allegiant", "frontier", "ryanair", "scoot", "spirit", "sun country"];
var isAwfulCarrier = function isAwfulCarrier(layover) {
  var airlineName = layover.operatingAirline.display.toLowerCase();
  return AWFUL_CARRIERS.some(function (shortNameString) {
    return airlineName.includes(shortNameString);
  });
};

/***/ }),

/***/ "./src/shared/utilities/pain/layovers/isLong.ts":
/*!******************************************************!*\
  !*** ./src/shared/utilities/pain/layovers/isLong.ts ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
var isLong = function isLong(fauxStartDate, fauxEndDate, isOvernight) {
  var tooLong = isOvernight ? 10 * 60 // 10 hours
  : 3 * 60; // 3 hours

  var layoverDurationInMinutes = Math.abs(fauxEndDate.valueOf() - fauxStartDate.valueOf()) / 60000;
  return layoverDurationInMinutes > tooLong;
};

/***/ }),

/***/ "./src/shared/utilities/pain/layovers/isOvernight.ts":
/*!***********************************************************!*\
  !*** ./src/shared/utilities/pain/layovers/isOvernight.ts ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
var isOvernight = function isOvernight(startTime, endTime) {
  return Math.floor(startTime.hours / 24) !== Math.floor(endTime.hours / 24) || startTime.hours % 24 < 2 && endTime.hours % 24 <= 9;
};

/***/ }),

/***/ "./src/shared/utilities/pain/layovers/isShort.ts":
/*!*******************************************************!*\
  !*** ./src/shared/utilities/pain/layovers/isShort.ts ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
var isShort = function isShort(fauxStartDate, fauxEndDate, isOvernight) {
  var tooShort = isOvernight ? 360 : 60; // less than 6 hours basically means you're trapped in the airport
...
(0,_background_state__WEBPACK_IMPORTED_MODULE_2__.ExtensionUpdateAvailableHandler)(providerManager);
chrome.runtime.onMessage.addListener( /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(function* (message, sender, reply) {
    ...
    switch (message.event) {
      ...
      case "FAILED_SCRAPER":
        (0,_background_eventHandlers__WEBPACK_IMPORTED_MODULE_0__.handleScraperFailed)(providerManager, message.providerName, message.description, message.searchType, message.windowConfig);
        break;
      ...
      case "UPDATE_NOW":
        (0,_background_eventHandlers__WEBPACK_IMPORTED_MODULE_0__.handleUpdateRequest)();
        break;

      case "OPEN_EXTENSION":
        yield (0,_background_eventHandlers__WEBPACK_IMPORTED_MODULE_0__.handleOpenExtensionRequest)(sender);
        break;
