...
export const getUrl = (formData: FlightSearchFormData): string => {
  ...
  return `https://www.kiwi.com/us/search/results/${from}/${to}/${fromDate}/${returnDate}?adults=${numPax}&cabinClass=${cabinValue}-false&returnFromDifferentAirport=false&returnToDifferentAirport=false`;
};
